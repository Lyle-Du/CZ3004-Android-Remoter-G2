...
module.exports = {
    ...
    getConnectedDevice: function (success, failure) {
        cordova.exec(success, failure, "BluetoothSerial", "getConnectedDevice", []);
    },
    setConnectedNotifyListener: function (success, failure) {
        cordova.exec(success, failure, "BluetoothSerial", "setConnectedNotifyListener", []);
    },
    clearConnectedNotifyListener: function (success, failure) {
        cordova.exec(success, failure, "BluetoothSerial", "clearConnectedNotifyListener", []);
    }
};
