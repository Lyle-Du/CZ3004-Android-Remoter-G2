...
public class BluetoothSerial extends CordovaPlugin {
    ...
    //added by DU QIU
    private static final String GET_CONNECTED_DEVICE = "getConnectedDevice";
    private static final String SET_CONNECTED_NOTIFY_LISTENER = "setConnectedNotifyListener";
    private static final String CLEAR_CONNECTED_NOTIFY_LISTENER = "clearConnectedNotifyListener";
    ...
    //added by DU QIU
    private static CallbackContext connectedCallback;
    ...
    public boolean execute(String action, CordovaArgs args, CallbackContext callbackContext) throws JSONException {
        ...
        }else if(action.equals(GET_CONNECTED_DEVICE)){//added by DU QIU
            
            getConnectedDevice(callbackContext);
            
        }else if(action.equals(SET_CONNECTED_NOTIFY_LISTENER)){//added by DU QIU
            
            this.connectedCallback = callbackContext;
            
        }else if(action.equals(CLEAR_CONNECTED_NOTIFY_LISTENER)){//added by DU QIU
    ...
    private void notifyConnectionLost(String error) {
        ...
        if (connectedCallback != null) {
            Log.d(TAG,"try to notify ui by connection lost");
    ...
    private void notifyConnectionSuccess() {
        Log.d(TAG,"try to notify ui");
        if (connectCallback != null) {
            Log.d(TAG,"try to notify ui by connectCallback");
        ...
        if (connectedCallback != null) {
            Log.d(TAG,"try to notify ui by connection established");
            PluginResult result = new PluginResult(PluginResult.Status.OK);
            result.setKeepCallback(true);
            connectedCallback.sendPluginResult(result);
        }
    ...
    //added by DU QIU
    private void getConnectedDevice(CallbackContext callbackContext) throws JSONException {
        BluetoothDevice mConnectedDevice = bluetoothSerialService.getConnectedDevice();
        try {
            JSONObject device = deviceToJSON(mConnectedDevice);
