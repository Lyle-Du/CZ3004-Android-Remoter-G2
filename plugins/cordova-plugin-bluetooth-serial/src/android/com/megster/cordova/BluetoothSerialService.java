...
//      Listen isn't working with Arduino. Ignore since assuming the phone will initiate the connection.
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device, final String socketType) {
        ...
        Log.d(TAG, "Device Name: "+device.getName()+". ID: "+device.getAddress());
        mConnectedDevice = device;
        Log.d(TAG, "Updated connectedDevice Name: "+mConnectedDevice.getName()+". ID: "+mConnectedDevice.getAddress());
